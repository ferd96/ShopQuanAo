        ...
        <div class="container" style="margin-top: 10px;">
            <div class="row" style="border: 1px darkgrey solid; border-radius: 10px;width: 50%; margin: 0 auto; padding: 20px;" >
                <div class="col-sm-12">
                    ...
                    <form:form action="/account/SaveOrUpdate" modelAttribute="item" method="post" enctype="multipart/form-data">
						...
						<div class="form-group">
                            <label>Photo</label>
                            <input name="image"  type="file"  class="form-control"  placeholder="Enter photo"/>
                        </div>
                        <div class="form-group">
                            <label>Status</label>
