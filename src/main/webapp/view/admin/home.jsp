            ...
            <div class="col-xl-12">
                ...
                <div class="card spur-card">
                    <div class="card-header">
                        ...
                        <div class="spur-card-title"> Thêm Thể Loại</div>
                    </div>
                    <div class="card-body ">
                        <form:form action="/category/index" modelAttribute="item">
                            ...
                            <div class="submit--right">
                                ...
                                <div class="form-group-button row">
                                    <div class="col-sm-10 ">
                                        <button formaction="/category/create" type="submit" 
                                ...
                                <div class="form-group-button row">
                                    <div class="col-sm-10 ">
                                        <button type="submit" class="btn btn-primary button-color-save"><a class="thea" href="/category/delete/${item.id}">Delete</a></button>
                                    </div>
                                </div>
                                 <div class="form-group-button row  ">
                                    <div class="col-sm-10 ">
                                        <button type="submit" class="btn btn-primary  button-color-Reset"><a class="thea" href="/category/index">Reset</a></button>
                                    </div>
                                </div>
                            ...
                            <tbody>
                             <c:forEach var="item" items="${items}">
                                <tr>
                                    ...
                                    <td>${item.name}</td>
                                    <td> 
                                        <a href="/category/edit/${item.id}" class="btn btn-outline-warning"> <i class="fas fa-edit"></i></a>
                                    </td>
